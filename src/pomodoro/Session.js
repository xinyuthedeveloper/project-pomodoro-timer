...
function Session({ session, focusDuration, breakDuration, isTimerRunning }){
   ...
   const currentSession = session?.label === "Focusing" ? (`Focusing for ${minutesToDuration(focusDuration)} minutes`) : (`On Break for ${minutesToDuration(breakDuration)} minutes`);
        ...
        <div className="row mb-2">
          <div className="col">
            ...
            <h2 data-testid="session-title">
              {currentSession/* ${session?.label} for 25:00 minutes  */}
            </h2>
